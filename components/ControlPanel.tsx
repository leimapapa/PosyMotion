        ...
        <div className="space-y-10 pb-16 lg:pb-0">
          ...
          <section>
            <div className="flex justify-between items-end mb-4">
              <label className="text-xs font-black uppercase tracking-widest text-zinc-100">Frame Delay</label>
            ...
            />
            <p className="mt-3 text-[11px] text-zinc-300 leading-relaxed font-bold uppercase tracking-tight">Shift temporal distance between current and ghost layers.</p>
          </section>

          {/* Opacity */}
          <section>
            <div className="flex justify-between items-end mb-4">
              <label className="text-xs font-black uppercase tracking-widest text-zinc-100">Mix Weight</label>
          ...
          <section>
            <div className="flex justify-between items-end mb-4">
              <label className="text-xs font-black uppercase tracking-widest text-zinc-100">Hue Rotation</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button 
              ...
              className={`p-6 rounded-2xl border-2 text-[12px] font-black uppercase tracking-widest transition-all active:scale-95 ${config.invert ? 'bg-blue-600 border-blue-400 text-white shadow-2xl shadow-blue-900/50' : 'bg-zinc-800 border-white/10 text-zinc-100 hover:text-white'}`}
            >
              Invert Delta
            </button>
            <button 
              onClick={() => updateConfig('grayscale', !config.grayscale)}
              className={`p-6 rounded-2xl border-2 text-[12px] font-black uppercase tracking-widest transition-all active:scale-95 ${config.grayscale ? 'bg-blue-600 border-blue-400 text-white shadow-2xl shadow-blue-900/50' : 'bg-zinc-800 border-white/10 text-zinc-100 hover:text-white'}`}
            >
              Mono Chrome
            </button>
          </div>
          ...
          <div className="space-y-8 pt-8 border-t border-white/10">
            <div>
               <div className="flex justify-between mb-3">
                <label className="text-[11px] font-black uppercase tracking-widest text-zinc-100">Brightness</label>
            ...
            <div>
               <div className="flex justify-between mb-3">
                <label className="text-[11px] font-black uppercase tracking-widest text-zinc-100">Contrast</label>
